...
class SeqNN(nn.Module):
    def __init__(self, device):
        ...
        self.conv_conv_dropout = ConvConvDropBlock(dilation=2)
        self.conv_conv_dropout1 = ConvConvDropBlock(dilation=2)
        self.conv_conv_dropout2 = ConvConvDropBlock(dilation=2)
        self.conv_conv_dropout3 = ConvConvDropBlock(dilation=2)
        self.conv_conv_dropout4 = ConvConvDropBlock(dilation=2)
        self.conv_conv_dropout5 = ConvConvDropBlock(dilation=2)
